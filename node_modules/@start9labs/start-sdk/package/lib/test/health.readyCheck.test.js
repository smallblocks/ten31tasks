...
describe("Health ready check", () => {
  ...
  `;
        expect((0, checkPortListening_1.containsAddress)(input, 80)).toBe(true);
        expect((0, checkPortListening_1.containsAddress)(input, 1234)).toBe(false);
    });
});
//# sourceMappingURL=health.readyCheck.test.js.map