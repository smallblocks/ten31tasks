import { IParser, ISimpleParsedError, NonNull, OnParse, Optional } from "./interfaces";
import { DeepReadonly } from "./on-mismatch";
...
export declare class Parser<A, B> implements IParser<A, B> {
    ...
    mapVoid: <C>(defaultValue: C) => Parser<Optional<A> | null, C | NonNull<B, C>>;
    /**
     ...
     * and in those cases during the parse we want it to fall back to a value
     */
    withMismatch: <C extends DeepReadonly<B>>(otherValue: (a: A) => C) => Parser<A, B>;
    /**
     ...
     */
    withRetry: <C extends A>(otherValue: (a: unknown) => C) => Parser<unknown, B>;
    retryable: () => boolean;
    /**
