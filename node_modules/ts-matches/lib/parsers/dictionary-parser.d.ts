...
import { _, IParser, OnParse } from "./interfaces";
export type DictionaryTuple<A> = A extends [Parser<unknown, infer Keys>, Parser<unknown, infer Values>] ? Keys extends string | number ? {
    [key in Keys]: Values;
} : never : never;
...
export declare const dictionary: <ParserSets extends [Parser<unknown, unknown>, Parser<unknown, unknown>][]>(...parsers: ParserSets) => Parser<unknown, _<DictionaryShaped<[...ParserSets]>>>;
