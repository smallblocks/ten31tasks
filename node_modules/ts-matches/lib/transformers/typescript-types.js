...
exports.parserAsTypescriptString = parserAsTypescriptString;
function parserAsTypescriptString(validator) {
    let result = null;
...
function parserAsTypescriptStringDuplicated(validator) {
    if (!validator) {
        return "unknown";
    }
