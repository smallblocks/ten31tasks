import { any, arrayOf, boolean, deferred, dictionary, every, guard, instanceOf, isFunction, literal, literals, natural, number, object, Parser, partial, recursive, regex, shape, some, string, tuple, ValidatorError } from "./parsers/index";
...
export type WhenArgsExclude<A> = A extends [ValueOrFunction<infer T, infer V>] ? T extends unknown ? any : T : A extends ([
    ...ParserOrLiteral<infer In>[],
    ValueOrFunction<infer In, infer Out>
]) ? In : never;
type _<A> = A;
...
export type WhenArgsOutput<A> = A extends [ValueOrFunction<infer T, infer V>] ? V : A extends ([
    ...ParserOrLiteral<infer In>[],
    ValueOrFunction<infer In, infer Out>
]) ? Out : never;
export type UnwrapFn<In, OutcomeType> = [
    In
] extends [never] ? () => OutcomeType : never;
...
declare const array: typeof arrayOf & Parser<unknown, unknown[]>;
/**
...
export declare const matches: (<Ins extends unknown>(value: Ins) => MatchMore<Ins, never>) & {
    array: typeof arrayOf & Parser<unknown, unknown[]>;
    ...
    object: typeof shape & Parser<unknown, object>;
    ...
    dictionary: <ParserSets extends [Parser<unknown, unknown>, Parser<unknown, unknown>][]>(...parsers: ParserSets) => Parser<unknown, import("./parsers/interfaces")._<import("./parsers/dictionary-parser").DictionaryShaped<[...ParserSets]>>>;
    literals: typeof literals;
    nill: Parser<unknown, null | undefined>;
    instanceOf: <C>(classCreator: {
        new (...args: any[]): C;
    }) => Parser<unknown, C>;
    Parse: typeof Parser;
